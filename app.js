  ...
  function firstMenuBox(onPasted) {
    ...
    return h('div', { style: 'border:1px dashed var(--faint);border-radius:16px;padding:16px;'
      ...
      h('div', { style: 'display:flex;flex-direction:column;gap:8px' }, [
        field,
        h('button', { style: 'border:2.5px solid var(--color-action);background:color-mix(in oklab, var(--color-action) 9%, var(--card));color:var(--color-action);font-family:inherit;font-size:15px;'
  ...
  function partialScreen(draft, menu, onBack) {
    ...
    return h('div', { style: 'display:flex;flex-direction:column;min-height:100vh' }, [
      ...
      h('div', {
        ...
        h('button', {
          style: 'border:2.5px solid var(--color-action);background:color-mix(in oklab, var(--color-action) 9%, var(--card));color:var(--color-action);font-family:inherit;font-size:15px;'
      ...
      h('div', { style: 'padding:16px 16px 22px;display:flex;flex-direction:column;gap:18px' }, [
        ...
        h('div', { style: 'display:flex;flex-direction:column;gap:10px' }, [
          ...
          h('div', { style: 'border:1px solid var(--line);border-radius:16px;padding:14px;'
            ...
            h('button', { style: 'border:2.5px solid var(--color-action);background:color-mix(in oklab, var(--color-action) 9%, var(--card));color:var(--color-action);font-family:inherit;'
  ...
  function a2hsScreen(onClose) {
    ...
    return h('div', { style: 'display:flex;flex-direction:column;min-height:100vh;background:var(--card)' }, [
      ...
      h('div', { style: 'padding:12px 20px 26px;display:flex;flex-direction:column;gap:8px' }, [
        installOffer ? h('button', { style: 'border:2.5px solid var(--color-action);background:color-mix(in oklab, var(--color-action) 9%, var(--card));color:var(--color-action);font-family:inherit;'
          + 'font-size:15px;font-weight:800;border-radius:16px;min-height:50px;'
        ...
        h('button', { style: installOffer
          ...
          : 'border:2.5px solid var(--color-action);background:color-mix(in oklab, var(--color-action) 9%, var(--card));color:var(--color-action);font-family:inherit;font-size:15px;'
